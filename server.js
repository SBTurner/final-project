...
app.listen(process.env.PORT || 3000, () => {
    db.sync().then(async() => {
        ...
        await Task.create({ "desc": "Buy groceries", "status": 0, "BoardId": board1.id, UserId: sarah.id })
        await Task.create({ "desc": "Prepare for exam", "status": 1, "BoardId": board1.id, UserId: krystyna.id })
        await Task.create({ "desc": "Create Kanban", "status": 2, "BoardId": board1.id, UserId: josie.id })
        ...
        await TaskItem.create({ "item": "Add CSS", "progress": 1, TaskId: 3})
        await TaskItem.create({ "item": "Make responsive", "progress": 1, TaskId: 3})
        await TaskItem.create({ "item": "Style forms", "progress": 1, TaskId: 3})
        await TaskItem.create({ "item": "Run cypress tests", "progress": 1, TaskId: 3})
        ...
        await TaskItem.create({ "item": "Buy textbooks", "progress": 1, TaskId: 2})
        await TaskItem.create({ "item": "Carrots", "progress": 0, TaskId: 1})
        await TaskItem.create({ "item": "Cheese", "progress": 0, TaskId: 1})
        await TaskItem.create({ "item": "Yoghurt", "progress": 0, TaskId: 1})
        await TaskItem.create({ "item": "Spinach", "progress": 0, TaskId: 1})
        await TaskItem.create({ "item": "Oranges", "progress": 0, TaskId: 1})
